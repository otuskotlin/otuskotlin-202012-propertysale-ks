package ru.otus.otuskotlin.propertysale.mp.transport.ps.models.house.responses
...
@Serializable
@SerialName("PsResponseHouseList")
data class PsResponseHouseList(
    ...
    val houses: List<PsHouseDto>? = null,
